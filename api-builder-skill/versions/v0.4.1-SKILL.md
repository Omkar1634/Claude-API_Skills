...
When the user chooses a specific language, load the relevant reference file before generating:

| Language chosen | Load this file |
|---|---|
| Python | `references/python-compatibility.md` |

These files contain known compatibility issues and correct code patterns for that language. Apply them when generating code — do not apply Python fixes to non-Python projects.
